/*
	...
	By Martin Coleman 2012-2013.
    This program, the WHOIS server, a part of the Regnum aka MUD4TLD project,
    comprising of wit_server.c, is hereby released into the public domain.
